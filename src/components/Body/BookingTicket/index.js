...
function BookingTicket() {
    ...
    const topMovie = useLocation().state.movies.splice(0, 3);
                    ...
                    <div className='movie-info'>
                        <div>
                            ...
                            <div className='movie-rate'>
                                ...
                                <span className='movie-rate-count'>({movie.vote_count} đánh giá)</span>
                            </div>
                        </div>
                        <button className='orange-btn rate-btn'>
                            Đánh giá
                        </button>
                    </div>
