...
export default function Profile() {
  ...
  const validator = () => {
    ...
    if (!oldpassword || !newpassword || !repassword) {
      alert(
        "Vui lòng nhập đủ mật khẩu cũ, mật khẩu mới và nhập lại mật khẩu mới!"
      );
      return false;
    }
      ...
      <div className="form-profile">
        ...
        <div className="control-info">
          <div className="one" style={{ marginRight: 12 }}>
            <span>Họ</span>
            <input
              className="input-div form-control"
              value={fname}
        ...
        <div className="d-flex align-items-center my-3">
          <input
            ...
            onChange={handleToggleShowAllPass}
          />
          <span>Hiện tất cả mật khẩu</span>
        </div>
        <Button color="primary" onClick={handleSaveInfoClick}>
          Lưu lại
        </Button>
      </div>
    </div>
