    ...
    <div id="update-news-page">
      ...
      <div className="update-area">
        <div className="input-wrapper">
          ...
          />
          <button className="select-btn orange-btn" onClick={handleSelectId}>
            Chọn
          </button>
          <button className="delete-btn orange-btn" onClick={handleDelClick}>
            Xoá bài viết
          </button>
        </div>
        ...
        <div className="input-wrapper">
          ...
          <img
            ...
            src={img ?? ""}
            alt="Không có ảnh để hiển thị"
          />
        </div>
        <div>
          <button className="save-btn orange-btn" onClick={handleSaveClick}>
            Lưu lại
          </button>
        </div>
      </div>
