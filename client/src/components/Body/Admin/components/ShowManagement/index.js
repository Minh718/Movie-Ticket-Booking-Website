    ...
    return (
        ...
        <div className="show-management">
            ...
            <form className="add-show-form" onSubmit={handleSubmit}>
                <Select name="movieShow" id="movieShow" className = "select_tag"
                        ...
                        />
                <input name="dateShow" id="dateShow" className = "select_tag"
                        placeholder="Nhập giá" onChange={(e) => {                 
                            setPrice(e.target.value);
                        }}></input>
                <Select name="room" id="room" className = "select_tag"
                            ...
                            return(
                                <li>
                                    ...
                                    <div className="show-modify">
                                        ...
                                        <AiFillDelete className="show-mod delete-show" onClick={async ()=>{
                                            await deleteShow({
                                                showID: show.showID
                                            });
                                            await fetchShows();
