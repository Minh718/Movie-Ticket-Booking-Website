    ...
    <div id="add-news-page">
      <div className="add-area">
        <div className="input-wrapper">
          ...
          <input className="title-ipt" type="text" onChange={e => setTitle(e.target.value)} />
        </div>
        <div className="input-wrapper">
          <span className="input-title">Tóm tắt bài viết</span>
          <textarea className="summary-ipt" rows="3" onChange={e => setSum(e.target.value)}>
          </textarea>
        </div>
        <div className="input-wrapper">
        ...
        <div className="input-wrapper">
          ...
          <input className="image-ipt" type='text' onChange={e => setImg(e.target.value)} />
        </div>
        <div>
          <button className="post-btn orange-btn" onClick={handlePostClick}>Đăng ngay</button>
        </div>
      </div>
      <div className="preview-area">
        ...
        <div className="preview-wrapper">
          <h3>{title}</h3>
          <img className="preview-img" src={img} alt="Địa chỉ ảnh chưa có hoặc không hợp lệ" />
          {
